...
|-----|-------------|---------------------|
| `v0.1.0` | Production baseline (Jan 2026) | `git checkout v0.1.0` |
...
# Remove a kernel
jupyter kernelspec remove lhn-prod
```
