...
| `showIU` | Method | Display sample records filtered by tenant (e.g., RWD) | `e.cohort.showIU(obs=10, tenant=127)` |
...
e.cohort.showIU(
    ...
    tenant=127,          # RWD Expert Determination (82 = Safe Harbor)
    sortfield=['personid'],
    sort_order='asc',
    label='Cohort Sample'
)
...
**Tenant IDs**:
- `127` - RWD Expert Determination (default)
- `82` - RWD Safe Harbor
