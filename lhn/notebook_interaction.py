...
def setup_environment(notebook_url):
    ...
    elif "lhn-community" in notebook_url and "work/Shared/RWD" in notebook_path:
        python_path = os.path.join(Path.home(), 'work', 'Shared', 'RWD', 'python')
        basePath = os.path.join(Path.home(), 'work', 'Shared', 'RWD')
