...
class Resources:
    def __init__(self, 
        ...
        if call_set_database:
            set_database('rwd_prime', 'conditions')
    ...
    def processIUHDataTable(self):
        ...
        self.processDataTables(data_type='IUHdataTables', schema_type='IUHSchema',
                              type_key='rwd', property_name='iuh',
    ...
    def update_resources(self, config_dict, debug=False):
        ...
        self.rwd = processDataTables(config_dict['IUHdataTables'], config_dict['IUHSchema'], self.dataLoc, self.disease, self.schemaTag, self.project, self.parquetLoc, debug)
        ...
        self.iuh = DB(self.__dict__, 'rwd')
        self.m = DB(self.__dict__, 'meta')
        user_prop = ['proj', 'rwd', 'rwd', 'meta', 'db', 'r', 'iuh', 'm']
        result = {}
